...
// Newest first, for the landing-page "recently added" grid — see
// CLAUDE.md "Design" for why the landing page shows this instead of a
// blank panel until you search.
export function mostRecentPairings(pairings, limit = 10) {
  return [...pairings]
